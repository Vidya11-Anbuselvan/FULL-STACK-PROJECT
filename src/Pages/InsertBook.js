...
export default function InsertBook() {
    ...
    const [user, setUser] = useState({
      ...
      const { bookid,bookname,authorId,author,rating,genreId,genre,publisherId,publisherName,price} = user;
      ...
      const onSubmit = async (e) => {
        e.preventDefault();
        await axios.post("http://localhost:8080/books", user);
        navigate("/");
      };
    ...
    <div className='container'>
        <div className='row'>
            <div className='col-md-6 offset-md-3 border rounded p-4 mt-2 shadow reg-label formbox-control'>
                <h2 className='text-center m-4 input3-label'>ADD A BOOK</h2>
